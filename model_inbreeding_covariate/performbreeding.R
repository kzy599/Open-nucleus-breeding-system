...
if(contrast){
  ...
  if(gem=="ssGBLUP"){source("ssGBLUPib.R")}else{source("pblupib.R")}
}
...
if(contrast){
  if(pname == "os"){fwrite(output,file = paste("ONBS","realg","ib",r,".csv",sep = ""),sep = ",",col.names = TRUE,row.names = FALSE,quote = FALSE)}
  
  if(pname == "op"){fwrite(output,file = paste("ONBS","realgp","ib",r,".csv",sep = ""),sep = ",",col.names = TRUE,row.names = FALSE,quote = FALSE)}
  
  if(pname == "cs"){fwrite(output,file = paste("CNBS","real1","ib",r,".csv",sep = ""),sep = ",",col.names = TRUE,row.names = FALSE,quote = FALSE)}
  
  if(pname == "cp"){fwrite(output,file = paste("CNBS","real2","ib",r,".csv",sep = ""),sep = ",",col.names = TRUE,row.names = FALSE,quote = FALSE)}
}else{
