...
if(substr(wdyw,nchar(wdyw)-nc+1,nchar(wdyw))!= "Open-nucleus-breeding-system-main/"){stop("The wdyw must end with Open-nucleus-breeding-system-main/")}
...
output <- data.frame(generation=0:(nGeneration),
                     ...
                     corac = numeric(nGeneration+1),
                     coracand = numeric(nGeneration+1),
                     coracmp = numeric(nGeneration+1),
                     accuracyib = numeric(nGeneration+1),
                     accuracyib_mp = numeric(nGeneration+1),
                     ibdcoe = numeric(nGeneration+1))
